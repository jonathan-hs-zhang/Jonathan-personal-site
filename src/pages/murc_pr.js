    ...
    <article className="post" id="murc">
      ...
      <div className="details">
        <div className="description">
          ...
          <img src={`${process.env.PUBLIC_URL}${'/images/murc/kezi.jpeg'}`} alt="1" width="600" height="800" />
          <p> Our design can be seen in the poster.</p>
          <p> Presented this poster at MURC finally on March 28, 2023. </p>
          <img src={`${process.env.PUBLIC_URL}${'/images/murc/poster.png'}`} alt="1" width="800" height="600" />
          <p> There are some pictures of me presenting at MURC. </p>
          <img src={`${process.env.PUBLIC_URL}${'/images/murc/audience1.jpeg'}`} alt="1" width="800" height="600" />
          <img src={`${process.env.PUBLIC_URL}${'/images/murc/audience2.jpeg'}`} alt="1" width="800" height="600" />
        </div>
      </div>
    </article>
  </Main>
